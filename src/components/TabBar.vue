...
export default {
  ...
  methods: {
    ...
    isBehavior(tab) {
      return (
        tab.item.type === TREE_TYPE.FILE &&
        tab.item.name === this.$store.state.projectConfiguration.dsdFileName
      );
    },
  },
  data: () => ({
...
.theme-dark .tabs-item.active .tabs-background-after,
.theme-dark .tabs-item.active .tabs-background-before {
...
.theme-dark,
.theme-dark .tabs-item .tabs-background-content {
