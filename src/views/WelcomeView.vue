    ...
    <div class="welcomeScreen justify-center" style="display: flex; flex-direction: column">
      <div>
        <v-row class="mt-12 justify-center align-center text-center" dense>
          ...
          <v-col cols="12">
            <div class="headline text-h4 textColor">Dynamic Stack Decider Interface</div>
          </v-col>
          <v-col cols="12">
            <div class="headline text-h6 text--white textColor align-center justify-center">
              Version 1.0.1
            </div>
          </v-col>
        </v-row>
      ...
      <v-sheet
        style="flex-grow: 1; width: 100%; display: flex; justify-content: space-between"
  ...
  mounted() {
    ...
    if (actualProject) {
      this.$store.commit("loadProject", {
        projectConfigurationLocal: actualProject,
      });
    }
  },
  methods: {
